<template>
  <section>
    <ul class="review-list">
      <span>
        <li v-for="review in owner.reviews" :key="review._id" class="review-item">
          <div class="reviewer-image">
              <label class="profile-pict"  style="width: 32px; height: 32px; font-size: 1em;">
                <img v-if="review.by.imgUrl" :src="review.by.imgUrl" alt="">
                <span v-else class="missing-profile-image flex-center">y</span>
              </label>
            </div>
          <header>
            <div class="reviewer-details">
              <h5>{{review.by.fullname}}</h5>
              <small class="review-rating">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1400" width="16" height="15">
          ...
          <div class="helpful-thumbs">
            <div class="helpful-thumb">
              <span class="thumbs-icon"  style="width: 14px; height: 14px;">
