<template>
  <section>
    <div v-if="gig" class="purchase-details">
      ...
      <div>
        <p class="p-purch-info">Up to 5 Original Products</p>
      </div>
      <!-- need to add offer to json? -->
    <div class="additional-info">

      <div class="seller-service"> 
        <span class="lFICM06 delivery-icon" aria-hidden="true" style="width: 16px; height: 16px;">
        ...
        </span><span class="service-line">7 Days Delivery</span>
        <span class="lFICM06 revisions-icon" aria-hidden="true" style="width: 16px; height: 16px;">
          <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
