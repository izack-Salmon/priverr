<template>
  <section class="explore flex">
    <div
      @click="openBudget"
      :class="['btn-budget', { 'btn-selected': budgetActive }]"
    >
      Budget
      <span
        :class="['arrow-down', { 'arrow-up': budgetOpen }]"
        aria-hidden="true"
        style="width: 10px; height: 10px; fill: #222325"
      >
        <svg
          width="11"
          height="7"
